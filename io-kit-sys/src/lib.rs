...
extern "C" {
  ...
  pub fn IONotificationPortSetDispatchQueue(notify: IONotificationPortRef, queue: dispatch_queue_t);
...
extern "C" {
  ...
  pub fn IOServiceWaitQuiet(service: io_service_t, waitTime: *mut mach_timespec_t)
    -> kern_return_t;
...
extern "C" {
  ...
  pub fn IOConnectTrap2(connect: io_connect_t, index: u32, p1: usize, p2: usize) -> kern_return_t;
...
extern "C" {
  ...
  pub fn IORegistryEntryFromPath(masterPort: mach_port_t, path: *mut c_char)
    -> io_registry_entry_t;
...
pub type IOAsyncCallback2 =
  unsafe extern "C" fn(refcon: *mut c_void, result: IOReturn, arg0: *mut c_void, arg1: *mut c_void);

pub type IOAsyncCallback =
  unsafe extern "C" fn(refcon: *mut c_void, result: IOReturn, args: *mut *mut c_void, numArgs: u32);
